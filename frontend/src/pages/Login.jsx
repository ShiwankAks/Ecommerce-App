    ...
    >
      <div className='inline-flex items-center gap-2 mb-2 mt-10'>
        <p className='prata-regular text-3xl'>{currentState}</p>
          <hr className='class="border-none h-[1.5px] w-8 bg-gray-800"'/>
      </div>
     {currentState==='Login'
     ?
     ""
     ...
     className='w-full px-3 py-2 border border-gray-900' placeholder='Name' 
     /> } 

      <input onChange={(e)=>setEmail(e.target.value)} type="email" value={email}
       className='w-full px-3 py-2 border border-gray-900' placeholder='Email' required
        />
