  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t  border-gray-400 ">
      ...
      <div className="min-w-60">
        <p onClick={()=>setShowFilter(!showFilter)} className="items-center flex text-xl gap-2 cursor-pointer">
          FILTERS
          <img  src={assets.dropdown_icon} className={` sm:hidden h-3 ${showFilter? 'rotate-90':""}`} alt="" />
        </p>

        {/* Category filter */}
        <div
          className={`border border-gray-300 mt-6 pl-6 py-3 ${
            showFilter ? "" : "hidden"
          } sm:block`}
        >
        ...
        <div
          className={`border border-gray-300 my-5 pl-6 py-3 ${
            showFilter ? "" : "hidden"
          } sm:block`}
        >
      ...
      <div className="flex-1">
        ...
        <div className=" justify-between text-base flex sm:text-2xl mb-4 ">
          <Title text1={'ALL'} text2={'COLLECTIONS'} />
          
          {/* Product Sort */}
          <select onChange={(e)=>setSortType(e.target.value)} className="text-sm border-gray-300 px-2 border-2  ">
